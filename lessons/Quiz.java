...
public class Quiz {
    ...
    private static void handleChoice(int choice, Scanner sc) {
        switch (choice) {
            case 1:
    ...
    private static void showExitMessage() {
        clearScreen();
        System.out.println(CYAN + "╔════════════════════════════════════════╗" + RESET);
        System.out.println(CYAN + "║" + GREEN + BOLD + "           THANK YOU FOR PLAYING!          " + RESET + CYAN + "║" + RESET);
        System.out.println(CYAN + "║" + YELLOW + "        Keep practicing to master Java!      " + RESET + CYAN + "║" + RESET);
        System.out.println(CYAN + "╚════════════════════════════════════════╝" + RESET);
        System.out.println();
        System.out.println(PURPLE + "🌟 Come back anytime for more practice!" + RESET);
        System.out.println();
    }
