...
public class Output {
    ...
    public static void main(Scanner sc) {
        ...
        System.out.println(CYAN + "═══════════════════════════════════════════════════════════════" + RESET);
        System.out.println(YELLOW + "🎯 Test your knowledge of Java output statements!" + RESET);
        System.out.println(GREEN + "✅ Type the exact syntax as used in Java" + RESET);
        System.out.println(CYAN + "───────────────────────────────────────────────────────────────" + RESET);
        ...
        System.out.println();
        System.out.println(CYAN + "───────────────────────────────────────────────────────────────" + RESET);
        System.out.println(GREEN + "💡 Hint: This method prints and moves to the next line" + RESET);
        System.out.println(CYAN + "───────────────────────────────────────────────────────────────" + RESET);
        ...
        while (!correct1 && attempts1 < 3) {
            ...
            if (answer.equals("println")) {
                System.out.println(GREEN + "✅ Correct! The println method prints and adds a new line." + RESET);
                score++;
                correct1 = true;
            } else {
                attempts1++;
                System.out.println(RED + "❌ Not quite right. What method prints with a new line?" + RESET);
                if (attempts1 < 3) {
                    System.out.println(YELLOW + "💡 Hint: It starts with 'print' and ends with 'ln'" + RESET);
        ...
        System.out.println();
        System.out.println(CYAN + "───────────────────────────────────────────────────────────────" + RESET);
        System.out.println(GREEN + "💡 Hint: Remember to include quotes for text in Java" + RESET);
        System.out.println(CYAN + "───────────────────────────────────────────────────────────────" + RESET);
        ...
        while (!correct2 && attempts2 < 3) {
            ...
            if (answer.equals("\"Hello Java\"")) {
                System.out.println(GREEN + "✅ Excellent! Strings in Java must be enclosed in double quotes." + RESET);
                score++;
                correct2 = true;
            } else {
                attempts2++;
                System.out.println(RED + "❌ That's not correct. How do we represent text in Java?" + RESET);
                if (attempts2 < 3) {
                    System.out.println(YELLOW + "💡 Hint: Text must be surrounded by double quotes" + RESET);
                    System.out.print(GREEN + "Try again: " + RESET);
                } else {
        ...
        if (score == totalQuestions) {
            ...
            System.out.println("🌟 You're a Java output expert!");
        } else if (score >= totalQuestions / 2) {
            System.out.println(YELLOW + "📚 GOOD JOB! " + score + "/" + totalQuestions + RESET);
            System.out.println("💪 Keep practicing and you'll master Java output!");
        } else {
            System.out.println(RED + "📖 KEEP LEARNING! " + score + "/" + totalQuestions + RESET);
            System.out.println("🔍 Review Java output statements and try again!");
        }
        
        System.out.println();
        System.out.println(CYAN + "───────────────────────────────────────────────────────────────" + RESET);
        System.out.println(GREEN + "Output Concepts Reviewed:" + RESET);
        System.out.println("• " + BLUE + "System.out.println()" + RESET + " - Prints text and moves to next line");
        System.out.println("• " + BLUE + "\"text\"" + RESET + " - Strings must be enclosed in double quotes"); 
        System.out.println("• " + YELLOW + "Other output methods: print(), printf()" + RESET);
        System.out.println("• " + YELLOW + "Note: println() adds new line, print() does not" + RESET);
        System.out.println(CYAN + "───────────────────────────────────────────────────────────────" + RESET);
        System.out.println();
